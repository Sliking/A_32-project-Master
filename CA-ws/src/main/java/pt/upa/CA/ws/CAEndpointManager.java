...
public class CAEndpointManager {
	 ...
	 * @throws Exception */
	public CAEndpointManager(String uddiURL, String wsName, String wsURL, String KeyPath) throws Exception {
		this.uddiURL = uddiURL;
		this.wsName = wsName;
		this.wsURL = wsURL;
		this.KeyPath = KeyPath;
		portImpl = new AsymKeysImpl(this.KeyPath);
	}

	/** constructor with provided web service URL */
	public CAEndpointManager(String wsURL, String KeyPath) {
		if (wsURL == null)
	...
	/** Port implementation */
	private AsymKeysImpl portImpl = null;

	/** Obtain Port implementation */
	public AsymKeysImpl getPort() {
		return portImpl;
	}
