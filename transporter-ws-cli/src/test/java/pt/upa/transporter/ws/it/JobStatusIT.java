 ...
 *//*
public class JobStatusIT extends SuperIT {

    // tests
    @Test
    public void test() throws BadLocationFault_Exception, BadPriceFault_Exception {
    	JobView jv = CLIENT.requestJob("Lisboa", "Coimbra", 11);
    	final JobView result = CLIENT.jobStatus(jv.getJobIdentifier());
        // assertEquals(expected, actual);
    	assertEquals("PROPOSED", result.getJobState().value());
